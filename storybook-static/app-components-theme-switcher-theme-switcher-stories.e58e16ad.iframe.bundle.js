...
(self.webpackChunkportfolio = self.webpackChunkportfolio || []).push([
  [340],
  {
    "./src/app/components/theme-switcher/theme-switcher.stories.tsx": (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          default: () => theme_switcher_stories,
        });
      var react = __webpack_require__(
        ...
        theme_switcher_module = __webpack_require__(
          "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[8].use[1]!./node_modules/postcss-loader/dist/cjs.js!./src/app/components/theme-switcher/theme-switcher.module.css",
        ),
        options = {};
      ...
      injectStylesIntoStyleTag_default()(theme_switcher_module.c, options);
      const theme_switcher_theme_switcher_module =
        theme_switcher_module.c && theme_switcher_module.c.locals
          ? theme_switcher_module.c.locals
          : void 0;
      var __jsx = react.createElement,
        ThemeSwitcher = function ThemeSwitcher() {
          var _useState = (0, react.useState)(0),
            themeState = _useState[0],
            setThemeState = _useState[1];
          (0, react.useEffect)(
            function () {
              var theme = 1 === themeState ? "light" : "dark";
          ...
          return __jsx(
            ...
            {
              className: ""
                .concat(theme_switcher_theme_switcher_module.button, " ")
                .concat(
                  1 === themeState
                    ? theme_switcher_theme_switcher_module["light-mode"]
                    : "",
                ),
              onClick: function toggleTheme() {
                setThemeState(function (prevState) {
                  return 0 === prevState ? 1 : 0;
                });
              },
            },
            0 === themeState ? "🌙" : "☀️",
      ...
      (DarkMode.parameters = {
        ...
        (LightMode.parameters = {
          ...LightMode.parameters,
          docs: {
            ...LightMode.parameters?.docs,
            source: {
              originalSource: "{\n  args: {}\n}",
              ...LightMode.parameters?.docs?.source,
            },
          },
        });
      const __namedExportsOrder = ["DarkMode", "LightMode"];
    },
    "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[8].use[1]!./node_modules/postcss-loader/dist/cjs.js!./src/app/components/theme-switcher/theme-switcher.module.css":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          ".theme-switcher_button__ripbg {\n  border: none;\n  border-radius: 50%;\n  width: 50px;\n  height: 50px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: var(--lower-opacity-color);\n  font-size: 24px;\n  cursor: pointer;\n}\n",
          "",
          {
            version: 3,
            sources: [
              "webpack://./src/app/components/theme-switcher/theme-switcher.module.css",
            ],
            names: [],
            mappings:
              "AAAA;EACE,YAAY;EACZ,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,4CAA4C;EAC5C,eAAe;EACf,eAAe;AACjB",
            sourcesContent: [
              ".button {\n  border: none;\n  border-radius: 50%;\n  width: 50px;\n  height: 50px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: var(--lower-opacity-color);\n  font-size: 24px;\n  cursor: pointer;\n}\n",
            ],
            sourceRoot: "",
          ...
          (___CSS_LOADER_EXPORT___.locals = {
            button: "theme-switcher_button__ripbg",
          });
