    ...
    "./src/stories/Page.stories.ts": (
      ...
      var asyncToGenerator = __webpack_require__(
        ...
        page = __webpack_require__(
          "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[8].use[1]!./node_modules/postcss-loader/dist/cjs.js!./src/stories/page.css",
        ),
        options = {};
      ...
      injectStylesIntoStyleTag_default()(page.c, options);
      page.c && page.c.locals && page.c.locals;
      var __jsx = react.createElement,
        Page = function Page() {
          var _React$useState = react.useState(),
            _React$useState2 = (0, slicedToArray.c)(_React$useState, 2),
                    ...
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        return (
                          ...
                          (canvas = (0, dist.Cu)(canvasElement)),
                          (loginButton = canvas.getByRole("button", {
                            name: /Log in/i,
                          })),
                          (_context.next = 5),
                          (0, dist.ct)(loginButton).toBeInTheDocument()
                        );
                      case 5:
                        return (_context.next = 7), dist.gr.click(loginButton);
                      case 7:
                        return (
                          (_context.next = 9),
                          (0, dist.ct)(loginButton).not.toBeInTheDocument()
                        );
                      case 9:
                        return (
                          ...
                          (_context.next = 12),
                          (0, dist.ct)(logoutButton).toBeInTheDocument()
                        );
                      case 12:
                      case "end":
