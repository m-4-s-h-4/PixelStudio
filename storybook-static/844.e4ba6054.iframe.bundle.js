  ...
  [844],
  {
    "./node_modules/@storybook/blocks/dist/Color-6VNJS4EI.mjs": (
      ...
      var R,
        ...
        Wrapper = dist.kb.div({ position: "relative", maxWidth: 250 }),
        PickerTooltip = (0, dist.kb)(components_dist.I9)({
          position: "absolute",
          zIndex: 1,
          top: 4,
          left: 4,
        }),
        TooltipContent = dist.kb.div({
          width: 200,
          margin: 5,
        ...
        Note = (0, dist.kb)(components_dist.Up)(({ theme }) => ({
          fontFamily: theme.typography.fonts.base,
        })),
        Swatches = dist.kb.div({
          display: "grid",
        ...
        SwatchColor = dist.kb.div(({ theme, active }) => ({
          width: 16,
          height: 16,
          boxShadow: active
        ...
        Input = (0, dist.kb)(components_dist.QF.Input)(({ theme }) => ({
          width: "100%",
          paddingLeft: 30,
          paddingRight: 30,
        ...
        ToggleIcon = (0, dist.kb)(components_dist.Ww)(({ theme }) => ({
          position: "absolute",
          zIndex: 1,
          top: 6,
          right: 7,
